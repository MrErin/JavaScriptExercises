...
// let stringDates = []
// sales.forEach(sale => {
// 	stringDates.push(sale.purchase_date)
// })
// console.log(stringDates)

// let sliceDates = []
// sales.forEach(sale => {
// 	if (sale.credit.credit_provider === 'Regions Financial Corporation'){
// 		sliceDates.push([`Get month by slicing produces: ${sale.purchase_date.slice(5,7)}; Get month by New Date.getMonth produces ${new Date(sale.purchase_date).getMonth()}`])
// 	}
// })
...
sales.forEach(sale => {
	console.log([sale.purchase_date.slice(5, 7), sale.purchase_date])
	if (!(sale.purchase_date.slice(5, 7) in salesMonth)) {
		salesMonth[sale.purchase_date.slice(5, 7)] = 1
	} else {
		salesMonth[sale.purchase_date.slice(5, 7)] += 1
