...
console.log(sortedArrayOfSales)


const topSales = sortedArrayOfSales.shift()
console.log('Steve\'s code says the top selling month is ' + topSales)

const monthNumber = topSales[0]
...
const months = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']
console.log(`The top selling month was ${months[[...ledger.entries()].sort(mapSort).shift()[0]]}`)
